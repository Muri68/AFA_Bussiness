...
SECRET_KEY = 'django-insecure-$3npfovc0%uk+58*jtxjclrk*eb1+$lf$a-s0j_twb3450r#to'
...
MIDDLEWARE = [
    ...
    # Add the DJANGO ALLAUTH middleware:
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'authentications.context_processors.get_vendor',
            ],
        },
    },
]
